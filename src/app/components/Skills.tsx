      ...
      <div className="bento-wrapper flex justify-center gap-4">
        ...
        >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="skill-image lg:w-32 w-20"
          >
            <Image
          ...
          <motion.div
            ...
            transition={{ delay: 1, duration: 0.3, ease: "easeOut" }}
            viewport={{ once: true }}
            className="skill-image bottom-0 md:-bottom-12 lg:-bottom-12 md:w-40 -left-8 rotate-3 absolute lg:-left-12"
          >
            <Image
          ...
          <motion.div
            ...
            transition={{ delay: 1, duration: 0.3, ease: "easeOut" }}
            viewport={{ once: true }}
            className="skill-image lg:w-32 w-20 right-0  absolute lg:top-0 lg:right-0 -rotate-12"
          >
            <Image
        ...
        >
          ...
          <motion.div
            ...
            transition={{ delay: 1 }}
            viewport={{ once: true }}
            className="skill-image absolute rotate-12"
          >
            <Image
          ...
          <motion.div
            ...
            transition={{ delay: 1, duration: 0.3, ease: "easeOut" }}
            viewport={{ once: true }}
            className="skill-image absolute md:bottom-0 lg:-right-12 lg:top-12 -right-8 -rotate-x-12"
          >
            <Image
      ...
      <div className="bento-wrapper flex justify-center gap-4 mt-4">
        ...
        >
          ...
          <motion.div
            ...
            className="skill-image absolute rotate-10 lg:-left-14 -left-8"
          >
            <Image
          ...
          <motion.div
            ...
            transition={{ delay: 1, duration: 0.5, ease: "easeOut" }}
            viewport={{ once: true }}
            className="skill-image -bottom-12 absolute lg:-bottom-10 lg:left-44"
          >
            <Image
          ...
          <motion.div
            ...
            transition={{ delay: 1, duration: 0.5, ease: "easeOut" }}
            viewport={{ once: true }}
            className="skill-image -right-18 absolute lg:-top-10 lg:-right-12 lg:-rotate-12 -rotate-45"
          >
            <Image
        ...
        >
          ...
          <motion.div
            ...
            transition={{ delay: 1, duration: 0.5, ease: "easeOut" }}
            viewport={{ once: true }}
            className="skill-image absolute rotate-12 -left-8 lg:left-0"
          >
            <Image
          ...
          <motion.div
            ...
            className="skill-image absolute -bottom-6 lg:-right-12 md:-right-14 -rotate-12"
          >
            <Image
